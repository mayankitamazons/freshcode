...
<div align="right">
        	<button onClick="document.location.href='import-Export-product.php'" class="btn btn-primary waves-effect waves-light">Import Export </button>
        	<br><br></div>
...
<td class="actions" align="center">
   ...
   <a class="on-default edit-row" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit Product" href="update-product.php?code=<?php echo $b['code']; ?>" ><i class="fa fa-pencil"></i></a> |
        ...
        <?php if($a=="Activate"){?>
         <a class="on-default edit-row" data-toggle="tooltip" data-placement="top" title="" data-original-title="Product Deactivate"  href="action-page/change-status.php?code=<?php echo $b['code']; ?>">
        ...
        <?php  } else {?>
         ...
         <a class="on-default edit-row" data-toggle="tooltip" data-placement="top" title="" data-original-title="Product Activate"  href="action-page/change-status.php?code=<?php echo $b['code']; ?>">
