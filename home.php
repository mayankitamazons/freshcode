...
$query1 = mysqli_query($con, "SELECT * FROM `order_info` WHERE `order_status`='in_process'");
...
$query2 = mysqli_query($con, "SELECT * FROM `order_info` WHERE `order_status`='in_process' AND `payment_method` ='CREDIT'");
...
$que = mysqli_query($con, "SELECT * FROM `purchase_rate` ORDER BY `sn` DESC");

$pur = mysqli_fetch_assoc($que);
$purchase_amount = $pur["tot"];

$total_profit = $total_amount - $purchase_amount;
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-4">
                            <div class="widget-bg-color-icon card-box">
                                ...
                                <div class="text-right">
                                    <h4 class="text-dark"> <b>Purchase Otp</b></h4>
                                    <h5 class="text-dark">&#8377 <b class="counter"><?php echo $otp; ?></b></h5>
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-4">
                            <div class="widget-bg-color-icon card-box">
                                ...
                                <div class="text-right">
                                    ...
                                    <h5 class="text-dark">&#8377 <b class="counter"><?php echo $purchase_amount;  ?></b></h5>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-4">
                            <div class="widget-bg-color-icon card-box fadeInDown animated">
                                ...
                                <div class="text-right">
                                    ...
                                    <h5 class="text-dark">&#8377 <b class="counter"><?php echo $total_profit; ?></b></h5>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                        </div>
