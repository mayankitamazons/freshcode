...
$query2= mysqli_query($con,"SELECT * FROM `vendor_cash` WHERE `purchases_id` = '$custId' ORDER BY sn DESC");
...
<div class="row" >
   ...
   <div class="card-box">
<?php
   $PayDetailsQuery= mysqli_query($con,"SELECT * FROM `purchase_rate` WHERE id='$custId'");
...
?>
        ...
        <form id="form1" method="post" action="action-page/vendor-cash.php">
			<div class="row" >
...
<td align="center"> <?php echo $b['purchases_id'];; ?> </td>
