...
<option value="CASH" <?php if($payment_method=="CASH") { ?> selected <?php } ?>>CASH</option>
														<option value="CREDIT" <?php if($payment_method=="CREDIT") { ?> selected <?php } ?>  >CREDIT</option>
											...
											<div class="col-lg-12" align="center"   class="row" id=tableRow>
												...
												<th>Delete</th>
													...
													<?php   
																	...
																	$query3 = mysqli_query($con,"SELECT fb_order.product,fb_order.price,fb_order.qty,fb_order.sub_total,fb_product.product_name,fb_product.product_hindi_name FROM `fb_order` INNER JOIN fb_product ON fb_product.code=fb_order.product WHERE `order_id`='$c'  ORDER by fb_order.sn ");
										...
										jQuery(document).ready(function($){
											...
											var i=<?php echo $i;?>;
                                                          ...
                                                          $('#product').change(function(){
															 // alert("dssad") ;
														//	 $("#addProduct").toggleClass('btn btn-inverse waves-effect waves-light btn btn-danger');
