...
$result_product=mysqli_query($con,"SELECT fb_order.qty
FROM fb_order
INNER JOIN order_info ON order_info.order_id=fb_order.order_id
WHERE fb_order.product='$p_code' AND order_info.order_status='in_process'");
