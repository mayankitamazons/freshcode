...
$query2 = mysqli_query($con, "SELECT * FROM `client_order` INNER JOIN client ON client.c_code=client_order.c_code AND client.c_city='Jaipur' ORDER BY client_order.sn DESC");
