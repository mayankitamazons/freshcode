...
$query2 = mysqli_query($con, "SELECT * FROM `inventory_info` WHERE `datee` ='$c'");
                    ...
                    <div class="card-box">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <form method="post" action="purchase-rate.php">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                while ($b = mysqli_fetch_assoc($query2)) {
                                                    ...
                                                    $pCode = $b['product_code'];
                                                    $query1 = mysqli_query($con, "SELECT * FROM `fb_product` WHERE `code` ='$pCode'");
