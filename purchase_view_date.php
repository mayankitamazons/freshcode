...
$query2= mysqli_query($con,"SELECT * FROM `purchase_rate` WHERE `date` ='$c'");
...
<div class="row" >
                            ...
                            <div class="col-sm-12">
									...
									<button onClick="document.location.href='purchase-rate.php'" class="btn btn-inverse waves-effect waves-light">Add New </button>
									</div>
...
?>
            ...
            <td ><?php echo $i; ?>   </td>
              ...
              <td> <?php echo $b['tot'] ?> </td>
                <td  >  <a href="update-purchase.php?code=<?php echo $b['id']; ?>"><label >Edit</label></a>
