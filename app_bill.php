...
$bill_no = $_GET["code"];
$query = mysqli_query($con, "SELECT * FROM `client_order` WHERE `order_id` = '$bill_no'");

$b = mysqli_fetch_assoc($query);
$cust_id = $b["c_code"];

$clientSql = mysqli_query($con, "SELECT * FROM `client` WHERE `c_code` = '$cust_id'");

$bb = mysqli_fetch_assoc($clientSql);

$billing_name = $bb["c_name"];


$getInvoiceId = mysqli_query($con, "SELECT * FROM `order_info` WHERE `order_id` = '$bill_no'");

$d = mysqli_fetch_assoc($getInvoiceId);
$invoice_id = $d["order_id"];
...
$query = mysqli_query($con, "SELECT * FROM `client` WHERE `cust_id` = '$cust_id'");

$b = mysqli_fetch_assoc($query);
$cname = $bb['c_name'];
$address = $bb['c_address'];
$state = $bb['state'];
$gst_no = $bb['gst_no'];
$pincode = $bb['pincode'];
$mobile = $bb['c_mobile'];
                                ...
                                <div align="center" style="width:659px;height:942px;margin-left:auto;margin-right:auto;padding:5px;" id="wp">
                                    ...
                                    <center>
                                                ...
                                                <td colspan="12">
                                                    <table width="100%" border="2px" style="color: black;border-collapse: collapse;padding-left:10px;">
                                                        ...
                                                        <tr colspan="12">
                                                            ...
                                                            <td style="padding:10px; " align="center" width="50%" colspan="6"><?php echo $payment_method; ?></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                        ...
                                        <table cellspacing="0" cellpadding="0" style="width:695px; height:auto;border-collapse: collapse;color: black;" border="2px">
                                            ...
                                            $i = 1;
                                            $total = 0;
                                            $getdata = mysqli_query($con, "SELECT * FROM `order_info` WHERE `order_id` = '$bill_no' ORDER BY order_info.sn");
