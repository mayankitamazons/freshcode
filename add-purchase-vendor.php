...
<html>
	...
	$query = mysqli_query($con,"SELECT * FROM `purchase_rate` ORDER BY `purchase_rate`.`sn` DESC limit 1");
				...
				<div class="content">
					<div class="container-fluid">
						...
						<div class="row">
							...
							<div class="col-sm-12">
								<div class="card-box">
									<form id="form1" method="post" action="action-page/add-purchase.php">
												...
												<div class="col-lg-5">
													...
													<div class="form-group">
														...
														<select onchange="selectName(this)" class="selectpicker" data-live-search="true" data-style="btn-white" id="vendor" name="vendor" required >
															...
															{
															?>
															<option value=<?php echo $b['vcode']; ?>  > <?php echo $b['name']; ?></option>
															<?php
															}
															?>
														</select>
