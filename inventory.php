...
$query2 = mysqli_query($con, "SELECT id,datee,SUM(remain)AS remain ,COUNT(dump)AS dump from inventory_info GROUP By inventory_info.datee ORDER BY `sn` DESC");
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12" align="center">
                            ...
                            <label style="font-size:25px;">Inventory Report</label>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <form method="post" action="add_inventory.php">
                                    <div align="right" class="col-sm-12">
                                        <button onClick="document.location.href=add_inventory.php" class="btn btn-inverse waves-effect waves-light">Add New </button>
                                    </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                ?>
                                                    ...
                                                    <td <label><?php echo $b['datee']; ?></label></td>
                                                    <td> <?php echo $b['remain'] ?> </td>
                                                    <td> <?php echo $b['dump'] ?> </td>
                                                    <td> <a href="view_inventory.php?code=<?php echo $b['datee']; ?>"><label> View Details</label></a></td>
