...
$query = mysqli_query($con, "SELECT * FROM `inventory` ORDER BY `inventory`.`sn` DESC limit 1");
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="card-box">
                                <form id="form1" method="post" action="action-page/inventory.php">

                                    <div class="row">
                                        <div class="col-lg-12" align="center">

                                            <label style="font-size:25px;">Inventory Create</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div id="productDiv" class="row">
                                        ...
                                        <div class="col-lg-5">
                                            ...
                                            <label>Enter Dump</label>
                                            <input onkeypress="return isNumberKey(event)" name="dump" id="dump" class="form-control" />
                                        </div>
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function($) {
            ...
            $('#addProduct').click(function() {
                ...
                $('#dataTable').append('<tr id="tr' + i + '" ><td >' + i + '</td><td ><label>' + productName + '<label><input type="hidden" name="product[]" value="' + productCode + '"size="30"  readonly/></td><td ><label>' + qty + '</label><input type="hidden" name="qty[]" value="' + qty + '"size="30"  readonly/></td><td ><label>' + dump + '</label><input type="hidden" name="dump[]" value="' + dump + '"size="30"  readonly/></td><td ><Button type="button" id="' + i + '"  class="btn btn-danger btn_remove" >X</button></td></tr>');
