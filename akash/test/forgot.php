...
<div class="container">
    ...
    <div class="col-sm-6 col-sm-offset-2" ><!-- col -->
		<h2><h1>Check your Phone!</h1></h2>
        <p class="desc">We’ve sent a six-digit confirmation code to <?php echo $number?>. Enter it below to confirm your mobile number.</p>
        <br><br><br>
       <label><span class="normal">Your </span>confirmation code</label>
         <div class="confirmation_code split_input large_bottom_margin" data-multi-input-code="true">
    			<div class="confirmation_code_group">
					<div class="split_input_item input_wrapper"><input type="text" class="inline_input" maxlength="1" required></div>
					<div class="split_input_item input_wrapper"><input type="text" class="inline_input" maxlength="1" required></div>
					<div class="split_input_item input_wrapper"><input type="text" class="inline_input" maxlength="1" required></div>
				</div>
             ...
             <button id="submit" onclick="myFunction()"><a href="verify.php">Verify</a></button>
            </div><!-- endof col -->
    </div>
</div>
</body>
