                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row" >
										 ...
										 <label style="font-size:25px;">Add Customer</label>
										 </div>
										 </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                      <form action="action-page/add-customer-php.php" method="post" >
                        ...
                        <input class="form-control" type="tel" pattern="[0-9]{10}" maxlength="10"  placeholder="Mobile Number" name="cnumber" >
                        </div>
						</div>
						  <div class="row">
                        ...
                        <input class="form-control" type="text"  placeholder="Gst Number" name="gst_no" >
                        </div>
						</div>
						<br>
                        ...
                        <div class="col-sm-12">
                            ...
                            <br>
                               <div class="col-sm-12" style="text-align: right; " >
                                   <button type="submit" class="btn btn-inverse btn-rounded waves-effect waves-light">Add Customer</button></div>
